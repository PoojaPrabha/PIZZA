...
<title>Insert title here</title>
   ...
   data-toggle="collapse" data-target="#collapse-example" aria-expanded="false">
		...
		<a class="navbar-brand" href=""><img src="${url }" alt="PIZZA" height="30px" width="30px"></a>
			</div>
			...
			<!-- productsUrl = http://localhost:9090/pizza/all/getallproducts -->
		...
		<c:url 
			...
			<a href='<c:url value='/all/registrationform'></c:url>'>Sign Up</a></li>
